...
后来我又尝试将一块好的板子的hex copy到坏板上，但是ubitto根本读不到坏板！

折腾了一上午之后发现作业一个没做已经绝望了。。。

最后翻到一个老哥的论坛帖子[请大神帮忙看看这款奇怪的MICRO BIT 板子]( https://bbs.eeworld.com.cn/thread-1198809-1-1.html)才发现——这板子根本就不是官方版！
HIC ID: 97969908，Bootloader 0254，用的是 STM32F103 当接口芯片，地址偏移和官方 KL26Z 完全不同。
原来它是某些编程课（核桃编程/量子兔）配的兼容板，一刷官方固件就变砖。

好在有大佬分享了专用固件，拖进 MAINTENANCE 盘，一秒复活！🎉
...
最后附上救砖文件，希望能帮到同样被坑的小伙伴。
[0254_kl26z_Microbit V1.1.hex](https://github.com/FireStar0507/microbit-daplink-for-hetao/)
